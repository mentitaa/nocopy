      ...
      <section className="px-6 py-24 bg-gray-50 border-t border-black/8">
        <div className="max-w-7xl mx-auto">
          <SectionHeading
            n="03 /"
            title="METHODOLOGY"
            sub="How we calculate the ranking."
          />
            ...
            {[
              {
                ...
                body: 'Net profit in USD generated by the trader in the selected period, including both closed and open positions.',
              },
              {
                icon: '◉',
                title: 'ROI',
                body: 'Return on investment: P&L divided by total capital deployed. Normalizes performance regardless of position size.',
              },
              {
                icon: '◊',
                title: 'Win Rate',
                body: 'Percentage of markets where the trader made a profit. Combined with P&L, it reflects the quality of decisions.',
              },
            ].map((card) => (
              <div
                key={card.title}
